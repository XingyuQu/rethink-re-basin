""" Based on:https://github.com/pytorch/vision/blob/main/torchvision/models/vgg.py """
...
class VGG(nn.Module):
    def __init__(self, features: nn.Module, special_init='vgg_init',
        ...
        self.classifier = nn.Sequential(
            nn.Linear(in_dim, num_classes, bias=bias),
        )
...
def _vgg(cfg: str, batch_norm: bool, layer_norm: bool,
         width_multiplier=1, bias=True, **kwargs: Any) -> VGG:
...
def cifar_vgg11(width_multiplier=1, **kwargs) -> VGG:
    return _vgg("A", batch_norm=False, layer_norm=False,
                width_multiplier=width_multiplier,
                **kwargs)


def cifar_vgg11_nobias(width_multiplier=1, **kwargs) -> VGG:
    return _vgg("A", batch_norm=False, layer_norm=False,
                width_multiplier=width_multiplier,
                bias=False, **kwargs)


def cifar_vgg11_bn(width_multiplier=1, **kwargs: Any) -> VGG:
    return _vgg("A", batch_norm=True, layer_norm=False,
                width_multiplier=width_multiplier,
                **kwargs)


def cifar_vgg11_ln(width_multiplier=1, **kwargs: Any) -> VGG:
    return _vgg("A", batch_norm=False, layer_norm=True,
                width_multiplier=width_multiplier,
                **kwargs)


def cifar_vgg13(width_multiplier=1, **kwargs: Any) -> VGG:
    return _vgg("B", batch_norm=False, layer_norm=False,
                width_multiplier=width_multiplier,
                **kwargs)


def cifar_vgg13_bn(width_multiplier=1, **kwargs: Any) -> VGG:
    return _vgg("B", batch_norm=True, layer_norm=False,
                width_multiplier=width_multiplier,
                **kwargs)


def cifar_vgg13_ln(width_multiplier=1, **kwargs: Any) -> VGG:
    return _vgg("B", batch_norm=False, layer_norm=True,
                width_multiplier=width_multiplier,
                **kwargs)


def cifar_vgg16(width_multiplier=1, **kwargs: Any) -> VGG:
    return _vgg("D", batch_norm=False, layer_norm=False,
                width_multiplier=width_multiplier,
                **kwargs)


def cifar_vgg16_nobias(width_multiplier=1, **kwargs) -> VGG:
    return _vgg("D", batch_norm=False, layer_norm=False,
                width_multiplier=width_multiplier,
                bias=False, **kwargs)


def cifar_vgg16_bn(width_multiplier=1, **kwargs: Any) -> VGG:
    return _vgg("D", batch_norm=True, layer_norm=False,
                width_multiplier=width_multiplier,
                **kwargs)


def cifar_vgg16_ln(width_multiplier=1, **kwargs: Any) -> VGG:
    return _vgg("D", batch_norm=False, layer_norm=True,
                width_multiplier=width_multiplier,
                **kwargs)


def cifar_vgg19(width_multiplier=1, **kwargs: Any) -> VGG:
    return _vgg("E", batch_norm=False, layer_norm=False,
                width_multiplier=width_multiplier,
                **kwargs)


def cifar_vgg19_bn(width_multiplier=1, **kwargs: Any) -> VGG:
    return _vgg("E", batch_norm=True, layer_norm=False,
                width_multiplier=width_multiplier,
                **kwargs)


def cifar_vgg19_ln(width_multiplier=1, **kwargs: Any) -> VGG:
