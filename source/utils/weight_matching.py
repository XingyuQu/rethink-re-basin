"""Based on: https://github.com/themrzmaster/git-re-basin-pytorch/blob/main/utils/weight_matching.py
    and https://github.com/samuela/git-re-basin/blob/main/src/weight_matching.py
"""
