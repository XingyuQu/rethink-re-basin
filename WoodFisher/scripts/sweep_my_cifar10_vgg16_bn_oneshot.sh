...
SWEEP_NAME="my_cifar10_vgg16_bn_oneshot"
NOWDATE=""
DQT='"'
GPUS=(0)
                ...
                do
                    ...
                    do
                        if [ "${FISHER_SUBSAMPLE_SIZE}" = 80 ]; then
                            ...
                            FISHER_MINIBSZS=(1)
                        elif [ "${FISHER_SUBSAMPLE_SIZE}" = 400 ]; then
                            FISHER_MINIBSZS=(1)
                        fi
