...
PRUNERS=(globalmagni) #globalmagni magni diagfisher woodfisherblock
JOINTS=(1)
FISHER_DAMP="1e-5"
EPOCH_END="1"
PROPER_FLAG="1"
...
NUM_SAMPLES=64
SWEEP_NAME="my_cifar10_resnet20_oneshot_${NUM_SAMPLES}_samples"
NOWDATE=""
DQT='"'
GPUS=(0)
